    ...
    <div className="relative min-h-screen bg-bg-primary text-text-primary flex flex-col selection:bg-accent/30 selection:text-white overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center max-w-[1400px] mx-auto px-6 pb-20 w-full">
        ...
        <section className="w-full flex justify-center mb-3 md:mb-4">
          <div className="w-full max-w-[1100px] h-[200px] sm:h-[280px] md:h-[350px] rounded-b-3xl border-x border-b border-white/[0.08] bg-bg-surface overflow-hidden relative shadow-[0_24px_80px_rgba(0,0,0,0.85)] shadow-accent/5 hover:border-accent/15 transition-all duration-300 -mt-px">
            <img
              src="/landing.png"
